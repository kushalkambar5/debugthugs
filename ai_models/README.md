...
- **Description:** Analyzes an X-ray image to detect bone fractures using YOLOv8.
...
- **Response Format (JSON):**
  ```json
  {
    ...
    "confidence": 98.50       // Percentage (0-100)
  }
  ```

## 2. Brain Tumor Detection
- **Endpoint:** `POST /predict/brain`
- **Description:** Detects brain tumors in MRI scans using YOLOv8 object detection.
- **Request Format:** `multipart/form-data`
- **Parameters:**
...
- **Response Format (JSON):**
  ```json
  {
    ...
    "confidence": 99.10       // Percentage (0-100)
  }
  ```
- **Classes:** 
...
- **Response Format (JSON):**
  ```json
  {
    "pathology_probabilities": {
      ...
      "Fracture": 0.80,
      "Lung Opacity": 50.20,
      "Enlarged Cardiomediastinum": 12.30
    }
  }
  ```
  *(Note: All values are percentages 0-100).*

## 6. Skin Disease Detection
- **Endpoint:** `POST /predict/skin`
- **Description:** Classifies skin diseases using YOLOv8 classification.
- **Request Format:** `multipart/form-data`
- **Parameters:**
...
- **Response Format (JSON):**
  ...
  {
    "diagnosis": "Eczema",
    "confidence": 94.20       // Percentage (0-100)
  }
  ```
