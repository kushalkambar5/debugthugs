...
def greet():
    return "The AI Digital Twin Medical Models API is running!\n\nPlease add '/docs' to the end of the URL in your browser to access the interactive API documentation and test the models."

demo = gr.Interface(
    fn=greet,
    inputs=[],
    outputs="text",
    title="AI Digital Twin Medical Models API",
    description="This Space hosts the backend FastAPI endpoints. Go to `/docs` to interact with the API."
)
